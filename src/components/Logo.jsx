...
const Logo = () => {
  return (
    ...
    >
      <g transform="matrix(1,0,0,1,-1.2121212121212466,0.3052930088799428)">
        <svg
          viewBox="0 0 396 81"
          data-background-color="#317c40"
        ...
        >
          <g
            id="tight-bounds"
            transform="matrix(1,0,0,1,0.2400000000000091,-0.060461451636371066)"
          >
            <svg
              viewBox="0 0 395.52 81.12065325060333"
              height="81.12065325060333"
              width="395.52"
            >
              <g>
                <svg
                  viewBox="0 0 533.5314921355991 109.4266362555849"
                  height="81.12065325060333"
                  width="395.52"
                >
                  <g transform="matrix(1,0,0,1,138.0114921355991,24.442498688274892)">
                    <svg
                      viewBox="0 0 395.52 60.54163887903511"
                      height="60.54163887903511"
                      width="395.52"
                    >
                      <g>
                        <svg
                  ...
                  <g>
                    <svg
                      viewBox="0 0 109.4266362555849 109.4266362555849"
                      height="109.4266362555849"
                      width="109.4266362555849"
                    >
                      <g>
                        <svg></svg>
                      </g>
                      <g id="icon-0">
                        ...
                        >
                          <g>
                            ...
                            ></path>
                            <ellipse
                              rx="54.16618494651452"
                              ry="54.16618494651452"
                              cx="54.71331812779245"
                              cy="54.71331812779245"
                              fill="#454545"
                              stroke="transparent"
                              strokeWidth="0"
                              fillOpacity="1"
                          ...
                          <g transform="matrix(1,0,0,1,24.08856921427968,31.438508953522746)">
                            <svg
                              viewBox="0 0 61.249497827025536 46.549618348539404"
                              height="46.549618348539404"
                              width="61.249497827025536"
                            >
                              <g>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <path
                                          d="M49.72 35.093c-8.964 0-16.231 7.268-16.231 16.231s7.268 16.231 16.231 16.231 16.231-7.268 16.231-16.231S58.684 35.093 49.72 35.093zM44.123 61.455V41.193l14.179 10.131L44.123 61.455z"
                                          fill="#3f9c51"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                      </g>
                                      ...
                                      >
                                        <path
                                          d="M100 83.03c0 3.297-2.673 5.97-5.97 5.97H5.97C2.673 89 0 86.327 0 83.03V18.97C0 15.673 2.673 13 5.97 13H94.03c3.297 0 5.97 2.673 5.97 5.97V83.03zM5 18v65h89.034L94.03 18H5z"
                                          fill="#3f9c51"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                      </g>
